...
ggplot(rna.wide.stringy, 
    ...
    labs(caption = paste0("Spearmans rho: ", round(aV4test$estimate, 3), 
                          ...
                          "\n", "N=", aV4testN)) +
    theme_classic()
ggsave("output/sampleMethod_AggieV4.pdf", width = 7, height = 7)
```
...
ggsave("output/sampleMethod_Barbee.pdf", width = 7, height = 7)
```
...
ggsave("output/dorm-ww-cor-matrix_rho.pdf")
...
ggsave("output/dorm-ww-cor-matrix_p.pdf")
...
ggsave("output/dorm-ww-cor-matrix_n.pdf")
